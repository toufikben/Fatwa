...
//   if MessageDlg('Â·  —Ìœ Õﬁ« «” —Ã«⁄ ﬁ«⁄œ… «·»Ì«‰«   ø', mtInformation , [mbok], 0, mbOk)=mrOk  then
...
procedure Tmain.MediaPlayer1Click(Sender: TObject; Button: TMPBtnType;
  var DoDefault: Boolean);
begin

//if MediaPlayer1.FileName='' then
//   ShowMessage('·„ Ì „ «Œ Ì«— „·› ’Ê Ì «Ê ·«ÌÊÃœ „·› ’Ê Ì «’·«');    MediaPlayer1.Close ;
end;
